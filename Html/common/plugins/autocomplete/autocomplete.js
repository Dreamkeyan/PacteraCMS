    ...
    $.fn.autocomplete = function(params) {
        ...
        this.each(function() {
            ...
            var proposals = $('<div></div>')
                ...
                .css('width', params.width + 12)
                .css('top', input.height() + 18);
            ...
            input.keydown(function(e) {
                switch(e.which) {
                    ...
                    case 13: // Enter
                        ...
                        var id = $( "ul.proposal-list li:eq(" + currentSelection + ")" ).attr('data-id');
                        currentSelection = -1;
                        proposalList.empty();
                        params.onSubmit(input.val(), id);
                        break;
                    case 27: // Esc button
                        currentSelection = -1;
                        proposalList.empty();
                ...
                if(e.which != 13 && e.which != 27
                    ...
                    if(input.val() != ''){
                        ...
                        for(var test in params.hints){
                            if(params.hints[test].value.indexOf(word) != -1){
                                currentProposals.push(params.hints[test]);
                                var element = $('<li></li>')
                                    .html(params.hints[test].value)
                                    .addClass('proposal')
                                    .attr('data-id', params.hints[test].id)
                                    .click(function(){
                                        input.val($(this).html());
                                        proposalList.empty();
                                        params.onSubmit(input.val(), $(this).attr('data-id'));
                                    })
                                    .mouseenter(function() {
