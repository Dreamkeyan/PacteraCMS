...
abstract class Addon
{
    ...
    public function __construct()
    {
        ...
        $this->addon_path   =   APP_PATH.'Addons'.DS.$this->getName().DS;
    ...
    final public function checkInfo(){
        $info_check_keys = array('name', 'description', 'status', 'author', 'version');
    ...
    final public function getConfig($name='')
    {
        ...
        $map['name']    =   $name;
        $map['status']  =   1;
        $config  =   M('SystemAddons')->where($map)->getField('config');
